...
class HostHandlerApp:
    """A simple application to retrieve and display Linux host information."""
    def __init__(self, root, width=900, height=700):
        self.root = root
        self.root.title("Linux Host Handler")
    ...
    def create_widgets(self):
        """Create GUI widgets."""
        self.label_title = tk.Label(self.root, text="Linux Host Handler", font=("Helvetica", 16))
